...
```{r,echo = FALSE, message = FALSE}
#make simple data frame of lobster abundance
lob_abundance <- lob_size_abundance %>% 
  select(YEAR,SITE,COUNT) %>% 
  filter(COUNT!=0)

#make simple data frame of traps
lob_traps_simple<-lob_traps %>% 
...
```{r,echo = FALSE, message = FALSE}
# make scatter plot for mean anual abundance by site (2012-2017)
...
#make column graph of total abundance by site
...
#Make a line graph of total abundance wihtin each site(2012-2017)
...
# make scatter plot for anual traps set by site (2012-2017)
...
#make column graph of total traps set by site 
...
lobsters observed (e.g., if the researcher saw 3 lobsters all with carapace length ~ 60 mm, then they will have a single row where COUNT = 3 and SIZE = 60). You’ll want to get this into case format - where each lobster
